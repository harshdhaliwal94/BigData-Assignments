...
public class PageRankNode implements Writable {
  ...
  public float getPageRankByIndex(int i) {
  ...
  public void setPageRankByIndex(int i, float p) {
  ...
  public String toString() {
    return String.format("{%d %s %s}", nodeid, (pagerank == null ? "[]": pagerank.toString(10)), (adjacencyList == null ? "[]"
